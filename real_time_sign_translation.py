...
# Load your trained model and label classes
...
def predict_sign(landmarks):
    # Preprocess input for your model shape
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                gesture_text = predict_sign(landmarks)

        # Display the predicted translation as a speech bubble
        if gesture_text:
            h, w, _ = frame.shape
